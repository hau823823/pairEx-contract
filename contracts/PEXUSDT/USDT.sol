...
contract TestToken is IERC20 {
    ...
    function updateGov(address govAddr) public {
        require(govAddr != address(0), "GOV IS NIL");
    ...
    function setDropletInterval(uint256 dropletInterval) public {
        require(msg.sender == _gov, "FaucetToken: forbidden");
        DROPLET_INTERVAL = dropletInterval.mul(1 hours);
    }
    ...
    /** @dev Creates `amount` tokens and assipex them to `account`, increasing
     * the total supply.
     *
